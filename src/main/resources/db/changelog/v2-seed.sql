...
--changeset arc-dev:v2-question-first-common
...
--changeset arc-dev:v2-question-second-common
INSERT INTO question (id, code, phase, classification, label, input_type, is_required, options, show_when, display_order) VALUES
...
--changeset arc-dev:v2-question-second-common-vasp
...
--changeset arc-dev:v2-question-second-corp
...
--changeset arc-dev:v2-question-second-corp-conditional
...
--changeset arc-dev:v2-question-second-corp-repeat
...
--changeset arc-dev:v2-question-second-corp-subfields
...
--changeset arc-dev:v2-question-second-indiv
INSERT INTO question (id, code, phase, classification, owner_segment_id, label, input_type, is_required, options, display_order) VALUES
...
--changeset arc-dev:v2-question-second-indiv-conditional
INSERT INTO question (id, code, phase, classification, owner_segment_id, label, input_type, is_required, options, show_when, parent_question_id, display_order) VALUES
...
--changeset arc-dev:v2-doc-template
