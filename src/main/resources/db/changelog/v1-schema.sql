...
--changeset arc-dev:v1-extensions splitStatements:false
create extension if not exists pgcrypto;

--changeset arc-dev:v1-segment
...
--changeset arc-dev:v1-question-index
create unique index question_code_active_uq on question (code) where deactivated_at is null;

--changeset arc-dev:v1-question-immutable-trigger splitStatements:false
...
--changeset arc-dev:v1-doc-template
...
--changeset arc-dev:v1-customer-index
create index customer_biz_reg_no_idx on customer (business_reg_no);

--changeset arc-dev:v1-onboarding-case
...
--changeset arc-dev:v1-case-indexes
...
--changeset arc-dev:v1-intake-response
...
--changeset arc-dev:v1-document-file
...
--changeset arc-dev:v1-document-file-index
create index document_file_document_idx on document_file (document_id);

--changeset arc-dev:v1-revision-request
...
--changeset arc-dev:v1-case-event-index
